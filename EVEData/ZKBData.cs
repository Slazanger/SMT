...
namespace SMT.EVEData
{
    public partial class SequenceData
    {
        ...
        public static SequenceData FromJson(string json) => JsonConvert.DeserializeObject<SequenceData>(json, Converter.Settings);
    }
    ...
    public partial class R2Z2Data
    {
        ...
        public static R2Z2Data FromJson(string json) => JsonConvert.DeserializeObject<R2Z2Data>(json, Converter.Settings);
    }
    ...
    public partial class Zkb
    {
        ...
        [JsonProperty("droppedValue")]
        public double DroppedValue { get; set; }

        [JsonProperty("destroyedValue")]
