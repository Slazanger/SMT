...
public class System
{
    ...
    /// </summary>
    public Vector2 Universe => new((float)UniverseX, (float)UniverseY);

    [XmlIgnore] public bool CustomUniverseLayout { get; set; }
    ...
    [XmlIgnore] public bool HasJumpBeacon { get; set; }
    ...
    [XmlIgnore] public float IHubOccupancyLevel { get; set; }

    [XmlIgnore] public DateTime IHubVunerabliltyEnd { get; set; }

    [XmlIgnore] public DateTime IHubVunerabliltyStart { get; set; }
    ...
    public string LocalizedName
    {
        get
        {
            ...
            {
                if (EveManager.Translations.ContainsKey(Name)) return EveManager.Translations[Name];
    ...
    [XmlIgnore] public float TCUOccupancyLevel { get; set; }

    [XmlIgnore] public DateTime TCUVunerabliltyEnd { get; set; }

    [XmlIgnore] public DateTime TCUVunerabliltyStart { get; set; }
    ...
    public string SecType
    {
        get
        {
            if (TrueSec >= 0.45) return "High Sec";

            if (TrueSec > 0.0 && TrueSec < 0.45) return "Low Sec";
