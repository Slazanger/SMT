...
{
    public class AsyncCommandEx<T> : AsyncCommandBase, INotifyPropertyChanged
    {
        ...
        public AsyncCommandEx(Func<T, CancellationToken, Task> command)
        {
            _command = command;
            _cancelCommand = new CancelAsyncCommand();
        }

        public AsyncCommandEx(Func<T, CancellationToken, Task> command, Func<bool> canExecute)
            : this(command)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            Execution = new NotifyTaskCompletionBase(_command((T)parameter, _cancelCommand.Token));
