...
{
    private static readonly Uri BaseUri = new("avares://SMTx/Styles");
    ...
    private static readonly Styles SimpleLight = new()
    {
        new StyleInclude(BaseUri)
        {
            Source = new Uri("avares://SMTx/Themes/SimpleLight.axaml")
        }
    };
    ...
    private static readonly Styles SimpleDark = new()
    {
        new StyleInclude(BaseUri)
        {
            Source = new Uri("avares://SMTx/Themes/SimpleDark.axaml")
        }
    };
